...
export const Select = forwardRef<HTMLDivElement, SelectProps>(
  (
    ...
    const sizeClasses =
      size === "sm"
        ? "h-8 text-sm px-3 py-2 min-h-[32px]"
        : "h-10 text-base px-3 py-2 min-h-[42px]";
    ...
    return (
      <div className="space-y-1">
        ...
        <div ref={containerRef} className="relative w-full">
          <div
            ref={ref}
            className={`w-full border border-slate-300 rounded-lg flex flex-wrap items-center gap-1 cursor-pointer transition hover:border-gold-400 ${sizeClasses} ${className}`}
